...
class SignalGenerator:
    ...
    def bb_width(self, period: int = 20, std_dev: float = 2.0, price: str = "close") -> Optional[float]:
    ...
    def bb_width_pct(self, period: int = 20, std_dev: float = 2.0, avg_period: int = 50, price: str = "close") -> Optional[float]:
